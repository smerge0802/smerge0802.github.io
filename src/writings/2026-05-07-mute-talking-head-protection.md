...
<figure class="research-figure research-figure-comparison">
  <a class="research-figure-scroll" href="/assets/writings/mute/paper-overview.png" aria-label="논문 Figure 1 MUTE 위협 모델 크게 보기"><img src="/assets/writings/mute/paper-overview.png" alt="얼굴 이미지와 원 음성이 talking-head exploitation에 사용되는 흐름과 MUTE 보호 음성이 black-box model, 후처리, denoiser, TTS 재합성 이후 입 모양을 어긋나게 만드는 비교"></a>
  <figcaption>논문 Figure 1의 실제 overview다. 위쪽은 원 음성으로 만든 동기화된 출력, 아래쪽은 MUTE 보호 음성이 black-box·postprocess·denoiser·TTS resynthesis를 거친 뒤 만든 어긋난 출력을 보여준다.</figcaption>
</figure>
...
<figure class="research-figure research-figure-comparison">
  <a class="research-figure-scroll" href="/assets/writings/mute/paper-framework.png" aria-label="논문 Figure 2 MUTE 전체 구조 크게 보기"><img src="/assets/writings/mute/paper-framework.png" alt="Adversarial audio에서 audio encoder와 cross attention으로 이어지는 representation-level, alignment-level loss와 STFT, ISTFT, PGD optimization을 연결한 MUTE 전체 구조"></a>
  <figcaption>논문 Figure 2의 실제 framework다. 가운데 파란 영역은 frame-wise representation loss, 위쪽 붉은 영역은 target attention KL loss, 아래쪽 녹색 경로는 STFT robustness constraint를 나타낸다.</figcaption>
</figure>
...
<figure class="research-figure research-figure-comparison">
  <a class="research-figure-scroll" href="/assets/writings/mute/paper-main-qualitative.webp" aria-label="논문 Figure 3 데이터셋별 정성 비교 크게 보기"><img src="/assets/writings/mute/paper-main-qualitative.webp" alt="TalkingHead-1KH와 CelebV-HQ에서 GT, C&W, Psychoacoustic, Qin, ARO, SAGO, MUTE의 얼굴과 입술 영역을 비교한 정성 결과"></a>
  <figcaption>논문 Figure 3의 실제 정성 비교다. 위쪽 (a)는 TalkingHead-1KH, 아래쪽 (b)는 CelebV-HQ다. MUTE 열에서는 같은 시점의 GT·baseline과 다른 입 모양과 치아 노출이 나타나 수치로 측정한 synchronization 저하를 시각적으로 확인할 수 있다.</figcaption>
</figure>
...
<figure class="research-figure research-figure-comparison">
  <a class="research-figure-scroll" href="/assets/writings/mute/paper-black-box-qualitative.webp" aria-label="논문 Appendix E.3 black-box 정성 비교 크게 보기"><img src="/assets/writings/mute/paper-black-box-qualitative.webp" alt="Hallo2, Audio2Head, SadTalker, Ditto에서 clean과 다섯 baseline, MUTE의 생성 프레임을 비교한 black-box transfer 결과"></a>
  <figcaption>논문 Appendix Figure E.3의 실제 black-box 비교다. 각 행은 Hallo2, Audio2Head, SadTalker, Ditto의 출력이며, 마지막 MUTE 열에서 surrogate와 구조가 다른 모델까지 lip shape가 달라지는 양상을 확인할 수 있다.</figcaption>
</figure>
...
<figure class="research-figure research-figure-comparison">
  <a class="research-figure-scroll" href="/assets/writings/mute/paper-robustness-qualitative.webp" aria-label="논문 Appendix E.4 adaptive attack 정성 비교 크게 보기"><img src="/assets/writings/mute/paper-robustness-qualitative.webp" alt="Sampling, filtering, Demucs, WavePurifier 이후 clean과 다섯 baseline, MUTE의 얼굴 프레임을 비교한 강건성 결과"></a>
  <figcaption>논문 Appendix Figure E.4의 실제 adaptive attack 비교다. 각 행은 sampling, filtering, Demucs, WavePurifier를 적용한 조건이며, 마지막 MUTE 열에서 제거 공격 이후에도 다른 mouth shape가 남는 장면을 보여준다.</figcaption>
</figure>
...
<figure class="research-figure research-figure-interface">
  <a class="research-figure-scroll" href="/assets/writings/mute/paper-user-study.png" aria-label="논문 Figure 4 사용자 평가 결과 크게 보기"><img src="/assets/writings/mute/paper-user-study.png" alt="MUTE 86.1%, ARO 5.5%, C&W 4.8%, SAGO 3.6%의 사용자 평가 선택 비율을 나타낸 원형 차트"></a>
  <figcaption>논문 Figure 4의 실제 user study 결과다. 참가자들은 네 방법 가운데 lip-sync mismatch가 가장 크게 느껴지는 영상을 골랐고, MUTE가 86.1%로 선택됐다.</figcaption>
</figure>
