...
<div class="project-meta" aria-label="연구 개요">
  <div><span>Published</span><strong>2024 · KCI</strong></div>
...
<figure class="research-figure research-figure-comparison">
  ...
  <figcaption>ASVspoof 2021 DF 결과. ResNet2가 전체 정확도 87.02%, EER 11.79%로 가장 낮은 EER을 보였습니다. 논문 Fig. 7.</figcaption>
</figure>

한편 클래스별 정확도 차이는 여전히 남았습니다. 이는 1:1로 전처리하더라도 훈련·검증·테스트 분할의 공격 유형과 난이도가 다르기 때문이며, 이후 연구에서는 더 다양한 생성기와 압축·전송 조건을 포함한 일반화 평가가 필요하다는 과제로 남겼습니다.
